...
<div>
 <form method="post">
  <input type="submit" value="Static" name="static"> <input type="submit" value="Overflow" name="overflow"> <input type="submit" value="Rainbow" name="rainbow"> <input type="submit" value="Pulse" name="pulse">
